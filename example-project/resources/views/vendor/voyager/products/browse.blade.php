...
@section('page_header')
    <div class="container-fluid">
       ...
       {{-- step1 --}}
        {{-- <a href="{{ url('vendor/voyager/products') }}" class="btn btn-primary" style="margin-left: 550px;">Export</a> --}}
        <a href="{{ route("generatePdf") }}" class="btn btn-primary" style="margin-left: 550px;">Export</a>
    </div>
@stop
